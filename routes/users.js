...
const fetch_all_users = async (req, res, next) => {
  const [users, response_code, response_message] =
    await user_controller.read_users_controller();
...
const fetch_single_user = async (req, res, next) => {
  const [user, response_code, response_message] =
    await user_controller.read_users_controller(req.params);
  if (response_code != response_codes.CODE_RESPONSE_SUCCESS) {
    return res
      .status(response_code)
      .send(common_utils.response_generator(response_code, response_message));
...
const signup_user = async (req, res, next) => {
  const [user, response_code, response_message] =
    await user_controller.signup_user_controller(req.body);
...
const create_user = async (req, res, next) => {
  const [user, response_code, response_message] =
    await user_controller.create_user_controller(req.body);
  if (response_code != response_codes.CODE_RESPONSE_CREATION_SUCCESS) {
    return res
      .status(response_code)
      .send(common_utils.response_generator(response_code, response_message));
...
const login_user = async (req, res, next) => {
  const [user, token, response_code, response_message] =
    await user_controller.login_user_controller(req.body);
  if (response_code != response_codes.CODE_RESPONSE_SUCCESS) {
    return res
      .status(response_code)
      .send(common_utils.response_generator(response_code, response_message));
...
const update_user = async (req, res, next) => {
  const [user, response_code, response_message] =
    await user_controller.update_user_controller(req.params, req.body);
  if (response_code != response_codes.CODE_RESPONSE_SUCCESS) {
    return res
      .status(response_code)
      .send(common_utils.response_generator(response_code, response_message));
...
const remove_user = async (req, res, next) => {
  const [user, response_code, response_message] =
    await user_controller.remove_user_controller(req.params);
  if (response_code != response_codes.CODE_RESPONSE_SUCCESS) {
    return res
      .status(response_code)
      .send(common_utils.response_generator(response_code, response_message));
